...
#   filename:  dehydration-metadata.v1.schema.json
#   timestamp: 2025-02-17T22:17:22+00:00
...
class Metadata(BaseModel):
    ...
    info: str = Field(
        ..., description="Any description you would like to add.", title="Metdata Info"
    )
...
class Transformer(BaseModel):
    ...
    min_pct_peak_loading: confloat(ge=0.0) = Field(
        ...,
        description="Minimum percenatge loading of these type of transformers during peak load.",
        title="Minimum Percentage Peak Loading",
    )
    avg_pct_peak_loading: confloat(ge=0.0) = Field(
        ...,
        description="Average percenatge loading of these type of transformers during peak load.",
        title="Average Percentage Peak Loading",
    )
    max_pct_peak_loading: confloat(ge=0.0) = Field(
        ...,
        description="Maximum percenatge loading of these type of transformers during peak load.",
        title="Maximum Percentage Peak Loading",
    )
    std_pct_peak_loading: Union[float, str] = Field(
        ...,
        description="Standard deviation percenatge loading of these type of transformers during peak load.",
        title="Standard Deviation Percentage Peak Loading",
    )


class FeederSection(BaseModel):
    ...
    min_pct_peak_loading: confloat(ge=0.0) = Field(
        ...,
        description="Minimum percenatge loading of these type of feeder sections during peak load.",
        title="Minimum Percentage Peak Loading",
    )
    avg_pct_peak_loading: confloat(ge=0.0) = Field(
        ...,
        description="Average percenatge loading of these type of feeder sections during peak load.",
        title="Average Percentage Peak Loading",
    )
    max_pct_peak_loading: confloat(ge=0.0) = Field(
        ...,
        description="Maximum percenatge loading of these type of feeder sections during peak load.",
        title="Maximum Percentage Peak Loading",
    )
    std_pct_peak_loading: Union[float, str] = Field(
        ...,
        description="Standard deviation percenatge loading of these type of feeder sections during peak load.",
        title="Standard Deviation Percentage Peak Loading",
    )
...
class VoltageMetric(BaseModel):
    ...
    num_phase: confloat(ge=1.0, le=3.0) = Field(
        ..., description="Number of phase.", title="Numberf of Phase"
    )
...
class DistributionSystemDehydratedDataset(BaseModel):
